  ...
  return (
    <div className="formContainer">
      ...
      <form className="formQuestions">
        ...
        <span>
          Gaat jouw vraag over een specifieke verhuurder/aanhanger? Vul hier de
          URL van de verhuurpagina in
        </span>
        <div className="formSelect" style={{ width: '100%' }}>
          <input
            placeholder="Http://www.buurbak.nl/aanbod"
            value={url}
