    ...
    <div>
      <div className="reservationContainer">
        <form className="reservationForm">
          ...
          <p>
            Toch niet helemaal waar je naar opzoek bent?{' '}
            <span>Zoek verder</span>
          </p>
          ...
          <div className="form">
            <p>
              Controleer je gegevens om je reservering van “Bakwagen ongeremd”
              compleet te maken. Je kan een bericht achterlaten voor de
