    ...
    <div className="pageContainer">
      ...
      <div className="popUpContainer">
        ...
        <div className="popUpContainerFilters">
          <div style={{ display: 'flex', width: '100%' }}>
            <div className="dateFilterContainer">
              <span>Algemeen</span>
              <p>
                Controleer de beschikbare aanhangers op de gewenste datum, prijs
                en locatie
              </p>
          ...
          <p className="filterCategoryText">
            Selecteer het gewenste aanhanger type waarnaar u op zoek bent.
          </p>
          ...
          <p className="filterCategoryText">
            Geef de gewenste afmetingen van uw aanhanger op zoals in het diagram
            weergeven hieronder.
          </p>
          ...
          <p className="filterCategoryText">
            Voor bepaalde aanhangers is een rijbewijs B+ of een rijbewijs BE
            verplicht. Niet zeker wat dit inhoudt? <span>Bekijk de uitleg</span>
          </p>
        ...
        <div className="popupContainerFooter">
          <button className="filterContentAction">Toon resultaten</button>
        </div>
      </div>
    </div>
  )
