...
export default function PersonalInfo({ currentUser }) {
  ...
  return (
    <div className="formStepContainer">
      ...
      <p>
        Controleer je persoonlijke gegevens als verhuurder. Dit is relevant voor
        het achterlaten van reviews, het bekijken van aanvragen en voor het
        regelen van betalingen.
      </p>
      <span>Verhuurt u zakelijk of als particulier?</span>
      <div style={{ marginTop: 15 }}>
        <RadioGroup defaultValue="particulier" name="radio-buttons-group">
          <FormControlLabel
            value="particulier"
            control={<Radio />}
            label="Ik verhuur als particulier"
          />
          <FormControlLabel
            value="business"
            control={<Radio />}
            label="Ik verhuur zakelijk"
          />
        </RadioGroup>
      </div>
