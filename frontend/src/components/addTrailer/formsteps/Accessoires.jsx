...
export default function Accessoires() {
  return (
    <div className="formStepContainer">
      <h2>Accessoires</h2>
      <p>
        Selecteer de accessoires waar de huurder gebruik van kan maken tijdens
        zijn huurperiode. Wanneer er geen accessoires beschikbaar zijn klikt u
        op geen.
      </p>
      <div className="trailerTypeGrid">
        <div className="trailerTypeIcon">
