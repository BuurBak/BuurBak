...
export default function General() {
    return (
        <div className="formStepContainer">
            <h2>Algemeen</h2>
            <p>Geef de algemene gegevens van de aanhanger op zoals de foto's, het gewicht en de draagcapaciteit. Ook kan je een korte beschrijving geven over de staat van de aanhanger.</p>
