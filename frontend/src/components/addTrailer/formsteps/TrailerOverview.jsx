import { TbArrowBarToRight, TbArrowBarToUp, TbCurrencyEuro, TbLocation, TbStars } from 'react-icons/tb'
...
export default function TrailerOverview({ trailerType, description }) {
    return (
        <div className="formStepContainer">
            ...
            <p>Controleer de vacature zodat alle velden correct zijn ingevuld en pas de informatie aan waar nodig. Als alles correct is ingevuld vind je je aanhanger binnen seconden online terug.</p>
            <div className="overviewImageGrid">
            ...
            <div className="overviewTrailerGrid">
                <div style={{ width: '100%' }}>
                    ...
                    <b>Omschrijving</b>
                    {!description
                        ? <p>Beschrijving niet aanwezig</p>
                        : <p>{description}</p>

                    }
                    <div className="divider" style={{ marginTop: 30 }} />
                </div>
                <div className="trailerOwnerContainer">
