    ...
    return (
        <div>
            <div className="headerContainer">
                <Link to="/"><img className="headerLogo" alt="logo" src={Logo}></img></Link>
            ...
            {showMenu
                ? <div className="sidebarHeaderContainer">
                    ...
                    <div className="sidebarHeader">
                        <IconButton className="closeMenuBtn" onClick={() => setShowMenu(false)}>
                            <IoIosClose size="32px" color="white" />
                        </IconButton>
                        <div className="headerMenuVertical">
                            <Link to='/aanbod' style={{ textDecoration: 'none', color: 'white' }}>Aanbod</Link>
                            <Link to='/blog' style={{ textDecoration: 'none', color: 'white', marginTop: 30 }}>Blog</Link>
                            <Link to='/verhuren' style={{ textDecoration: 'none', color: 'white', marginTop: 30 }}>Ik wil verhuren</Link>
                            <div style={{ textDecoration: 'none', color: 'white', marginTop: 30 }}>Inloggen</div>
                            <Link to='/contact' style={{ textDecoration: 'none', color: 'white', marginTop: 30 }}>Contact</Link>
                        </div>
                    </div>
                </div>
                : null
