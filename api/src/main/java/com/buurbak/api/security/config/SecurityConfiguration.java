...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/traileraccessoires", "/traileraccessoires/*").permitAll();
        http.authorizeRequests().antMatchers(HttpMethod.GET, "/traileroffer", "/traileroffer/*").permitAll();
        http.authorizeRequests().antMatchers(HttpMethod.DELETE,"/traileraccessoires" ,"/traileraccessoires/**").hasAnyAuthority("ROLE_ADMIN");
        http.authorizeRequests().antMatchers(HttpMethod.POST,"/traileraccessoires" ,"/traileraccessoires/**").hasAnyAuthority("ROLE_ADMIN");
